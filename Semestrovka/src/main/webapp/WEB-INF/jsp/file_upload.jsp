...
<div class="frame-fileupl">
<div>
<form method="post" enctype="multipart/form-data" action="/uploading?photosession="+<%request.getHeader("photosession");%>>
    ...
    <input type="submit" class="superbutton" id="sign-upp" name="submit" value="Add" />
</form>
</div>
